...
# Backend Page - Placeholder Content
    ...
    if st.button("Back to Home"):
        ...
        data = sheet.get_all_records()
        df = pd.DataFrame(data)
        worksheet = spreadsheet.sheet1 #Erstes Sheet der Excel Datei
                
        #Zugriff auf Daten
        headers = worksheet.row_values(1) #...der ersten Reihe/Employee Faktoren
        sheet_data = worksheet.get_all_values() #...der ganzen Tabelle
